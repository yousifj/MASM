...
Store	PROC
				...
				mov rbp,rsp							;copy pointer
				mov c1,cl							;store parm 1 in c1 
				mov s1,dx							;store parm 2 in s1 
				mov us1,r8w							;store parm 3 in us1
				mov i1,r9d							;store parm 4 in i1
				mov	rax,qword ptr[rbp+48]			;copy the content of the stack to rax
				mov ull1, rax						;store parm 5 in ull1
				mov rax,qword ptr[rbp+56]			;copy the content of the stack to rax
				mov	ll1,rax							;store parm 6 in ll1
				mov al,byte ptr[rbp+64]				;copy the content of the stack to rax
				mov uc1,al							;store parm 7 in uc1
