...
mWriteFile		MACRO
				...
				mov qword ptr [rbp + 32], 0		;parm5 = 0 (unused)
...
mainCRTStartup	PROC
				...
				mov r15,numRead					;get the size of first input
				...
				mov rdx, r15					;# of bytes to display
				mWriteFile						;display Input1
				
				lea rcx,Input2					;parm address of Input2
				mov rdx, numRead				;# of bytes to display
				sub rdx,2						;deleted enter key byte
